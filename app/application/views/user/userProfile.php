                            ...
                            <div class="col-lg-3 col-sm-4 col-md-3 col-xs-12">
                                <div style="margin: 0.5%;">
                                    <?php if($user->profile_picture) : ?>
                                        <img src="<?php echo base_url('/upload/user').'/'.$user->profile_picture;?>" alt="" class="img-rounded img-responsive" />
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role = "form" enctype="multipart/form-data" action="<?php echo site_url('upload-my-profile-picture');?>/<?php echo $user->iduser; ?>" method="POST">
                                                    <label>Image/picture/Photo</label>
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" name="userProfile" size="20" >
                                                    </div>
                                                    <div class="form-group">
