...
<div class="container" style="padding-top:70px;background-color:rgba(235,210,210,0.1);">
    ...
    <nav class="nav-sidebar">
		<ul class="nav tabs">
          ...
          <li class=""><a href="#photography" data-toggle="tab">Photography/Video</a></li>
          <li class=""><a href="#cakes" data-toggle="tab">Cakes</a></li> 
          <li class=""><a href="#salons" data-toggle="tab">Salons</a></li>  
          <li class=""><a href="#caterings" data-toggle="tab">Caterings</a></li>                               
          <li class=""><a href="#carHire" data-toggle="tab">Car Hire</a></li>                               
          <li class=""><a href="#mapambo" data-toggle="tab">Mapambo</a></li>                               
          <li class=""><a href="#musicHire" data-toggle="tab">Music Hire</a></li>                               
          <li class=""><a href="#cards" data-toggle="tab">Cards</a></li> 
          <li class=""><a href="#ukumbi" data-toggle="tab">Ukumbi</a></li> 
